...
public class ResultModel<T> {
    ...
    public ResultModel(Integer limit, Integer page, Integer pages, Long total, Boolean success, String msg, T data) {
        this.limit = limit;
        this.page = page;
        this.pages = pages;
        this.total = total;
    ...
    public ResultModel(Boolean success, Integer limit, Integer page, Integer pages, Long total, String msg, T data) {
        this.success = success;
        this.limit = limit;
        this.page = page;
        this.pages = pages;
